...
You can point Claude Hub at another Claude Code config directory:

```bash
CLAUDE_CONFIG_DIR=~/.claude-work npx claude-hub
```
...
- New Claude Code fields should be ignored until `claude-hub` uses them.
