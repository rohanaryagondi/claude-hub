...
Thanks for helping improve `claude-hub`. This project reads private local Claude Code data, so contributions should preserve the local-first, no-telemetry model.
...
- `bin/cli.js`: published `claude-hub` CLI entrypoint
